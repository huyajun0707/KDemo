...
public class SuperEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // a. 点击状态的左侧图标
        // 1. 获取资源ID
        ic_left_clickResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_left_click, 0);
        ...
        // b. 未点击状态的左侧图标
        // 1. 获取资源ID
        ic_left_unclickResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_left_unclick, 0);
        // 2. 根据资源ID获取图标资源（转化成Drawable对象）
        // 3. 设置图标大小（此处默认左侧图标点解 & 未点击状态的大小相同）
        if (ic_left_unclickResID != 0) {
        ...
        // 1. 获取资源ID
        ic_deleteResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_delete, R.drawable.icon_empty);
        // 2. 根据资源ID获取图标资源（转化成Drawable对象）
        ...
        int lineColorClick_default = context.getResources().getColor(R.color.color_fb8008); // 默认 = 主色调
        int lineColorunClick_default = context.getResources().getColor(R.color.color_line_dcdcdc); // 默认 = 灰色
