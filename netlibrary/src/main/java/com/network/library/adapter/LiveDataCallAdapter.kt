...
//                                value = onException(com.network.library.observer.ExceptionReason.BAD_NETWORK)
//                            } else if (e is ConnectException
//                                || e is UnknownHostException
//                            ) {   //   连接错误
//                                value = onException(com.network.library.observer.ExceptionReason.CONNECT_ERROR)
//                            } else if (e is InterruptedIOException) {   //  连接超时
//                                value = onException(com.network.library.observer.ExceptionReason.CONNECT_TIMEOUT)
//                            } else if (e is JsonParseException
//                                || e is JSONException
//                                || e is ParseException
//                            ) {   //  解析错误
//                                value = onException(com.network.library.observer.ExceptionReason.PARSE_ERROR)
//                            } else {
//                                value = onException(com.network.library.observer.ExceptionReason.UNKNOWN_ERROR)
//                            }
//                            postValue(value)
//                        }
//
...
//     * 异常统一处理函数
//     */
//    fun <T> onException(exception: com.network.library.observer.ExceptionReason): T {
//        when (exception) {
