...
class ProgressRequestBody : RequestBody {
    ...
    /**进度回调监听*/
    private var progressListener: com.network.library.upload.UploadProgressListener? = null
    private var bufferedSink: BufferedSink? = null

    constructor(requestBody: RequestBody?, progressListener: com.network.library.upload.UploadProgressListener) {
