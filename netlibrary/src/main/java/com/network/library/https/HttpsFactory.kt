package com.network.library.https
...
class HttpsFactory {
    ...
    constructor(private val localTrustManager: X509TrustManager) : X509TrustManager {
        ...
        init {
            ...
            defaultTrustManager =
                com.network.library.https.HttpsFactory.Companion.chooseTrustManager(var4.trustManagers)
        }
    ...
    companion object {
        ...
        fun getSslSocketFactory(
            ...
            try {
                val trustManagers =
                    com.network.library.https.HttpsFactory.Companion.prepareTrustManager(*certificates)
                val keyManagers =
                    com.network.library.https.HttpsFactory.Companion.prepareKeyManager(
                        bksFile,
                        password
                    )
                ...
                if (trustManagers != null) {
                    trustManager = com.network.library.https.HttpsFactory.Companion.chooseTrustManager(
                        trustManagers
                    )?.let { com.network.library.https.HttpsFactory.MyTrustManager(it) }
                } else {
                    trustManager = com.network.library.https.HttpsFactory.UnSafeTrustManager()
                }
